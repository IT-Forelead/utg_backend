...
case class Repositories[F[_]](
    ...
    vehicleFuelItems: VehicleFuelItemsRepository[F],
    vehiclePhotos: VehiclePhotosRepository[F],
    vehicleLicensePhotos: VehicleLicensePhotosRepository[F],
    ...
    tripFuelSupplies: TripFuelSuppliesRepository[F],
    tripFuelSupplyItems: TripFuelSupplyItemsRepository[F],
...
object Repositories {
  def make[F[_]: Async](
    ...
    Repositories(
      ...
      vehicleFuelItems = VehicleFuelItemsRepository.make[F],
      vehiclePhotos = VehiclePhotosRepository.make[F],
      vehicleLicensePhotos = VehicleLicensePhotosRepository.make[F],
      ...
      tripFuelSupplies = TripFuelSuppliesRepository.make[F],
      tripFuelSupplyItems = TripFuelSupplyItemsRepository.make[F],
