...
package object domain {
  ...
  @derive(eqv, show, uuid)
  @newtype case class VehicleFuelItemId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class VehiclePhotoId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class VehicleLicensePhotoId(value: UUID)
  @derive(eqv, show, uuid)
  ...
  @derive(eqv, show, uuid)
  @newtype case class TripTrailerId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class TripSemiTrailerId(value: UUID)
  @derive(eqv, show, uuid)
  ...
  @derive(eqv, show, uuid)
  @newtype case class TripFuelSupplyId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class TripFuelSupplyItemId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class TripFuelRateId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class TripRouteDelayId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class TripDriverId(value: UUID)
  @derive(eqv, show, uuid)
  ...
  @derive(eqv, show, uuid)
  @newtype case class TripCompleteTaskId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class TripCompleteTaskAcceptanceId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class DocumentId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class VehicleHistoryId(value: UUID)
  @derive(eqv, show, uuid)
  @newtype case class MedicalExaminationId(value: UUID)
